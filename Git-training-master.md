...
![git components](image/components.png)
...
![Cloning the remote repo](image/clone.png)
...
![Adding changes to the staging area](image/add.png)
...
![Committing to the local repo](image/commit.png)
...
![Pushing to the local repo](image/push.png)
...
![State of all components after pushing changes](image/after_push.png)
...
![States of a change an related diff commands](image/diffs.png)
...
![State after adding branch](image/add_branch.png)
...
![State after after switching branch](image/checkout_branch.png)
...
![Remote and local branches`](image/branches.png)
...
![Before fast forward merge](image/before_ff_merge.png)

The second diagram shows what has changed with our `merge`.

![After fast forward merge](image/ff_merge.png)
...
![Divergent commits](image/branches_diverge.png)
...
![Merging branches](image/merge.png)
...
![History before a rebase](image/before_rebase.png)
...
![History after rebase](image/rebase.png)
...
![many dev environments](image/many_dev_environments.png)
...
![Fetching changes](image/fetch.png)
...
![Pulling in changes](image/pull.png)
...
![Branches before cherry-picking](image/cherry_branches.png)
...
![Cherry-picking a single commit](image/cherry_pick.png)
...
![Cherry-picking commit range](image/cherry_pick_range.png)
...
![What happens in a push --force-with-lease](image/force_push.png)
